(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"/Users/Ben/projects/nanoscope/index.js":[function(require,module,exports){
'use strict';
...
},{"./lib/standard":"/Users/Ben/projects/nanoscope/lib/standard.js","./src/array/FilterLens":"/Users/Ben/projects/nanoscope/src/array/FilterLens.js","./src/array/IndexedLens":"/Users/Ben/projects/nanoscope/src/array/IndexedLens.js","./src/array/SliceLens":"/Users/Ben/projects/nanoscope/src/array/SliceLens.js","./src/base/Getter":"/Users/Ben/projects/nanoscope/src/base/Getter.js","./src/base/Lens":"/Users/Ben/projects/nanoscope/src/base/Lens.js","./src/base/Setter":"/Users/Ben/projects/nanoscope/src/base/Setter.js","./src/combinator/Compose":"/Users/Ben/projects/nanoscope/src/combinator/Compose.js","./src/combinator/ConjunctiveLens":"/Users/Ben/projects/nanoscope/src/combinator/ConjunctiveLens.js","./src/combinator/DisjunctiveLens":"/Users/Ben/projects/nanoscope/src/combinator/DisjunctiveLens.js","./src/combinator/MultiLens":"/Users/Ben/projects/nanoscope/src/combinator/MultiLens.js","./src/combinator/Optional":"/Users/Ben/projects/nanoscope/src/combinator/Optional.js","./src/nanoscope":"/Users/Ben/projects/nanoscope/src/nanoscope.js","./src/object/PathLens":"/Users/Ben/projects/nanoscope/src/object/PathLens.js","./src/object/PluckLens":"/Users/Ben/projects/nanoscope/src/object/PluckLens.js","lodash":"/Users/Ben/projects/nanoscope/node_modules/lodash/dist/lodash.js"}],"/Users/Ben/projects/nanoscope/lib/indexed/headLens.js":[function(require,module,exports){
"use strict";
 ...
 * @type {Lens}
 */
var IdLens = exports.IdLens = function IdLens() {
  return new _Lens2.default(_lodash2.default.identity, function (val, func) {
    return func(_lodash2.default.cloneDeep(val));
  });
};
...
module.exports = {
    headLens: require('./indexed/headLens'),
    lastLens: require('./indexed/lastLens'),
    IdLens: require('./primitives/IdLens'),
    initLens: require('./slice/initLens'),
 ...
 * @returns {*}
 */
normalizeIndex = function normalizeIndex(arr, index) {
    if (index < 0) {
 ...
 * @returns {boolean}
 */
isValidIndex = function isValidIndex(arr, index) {
...
var Lens = function Lens(get, map, flags) {
    ...
    if (this._flags._view) {
        this._view = _lodash2.default.clone(this._flags._view);
    }
}
...
},{"./Lens":"/Users/Ben/projects/nanoscope/src/base/Lens.js","lodash":"/Users/Ben/projects/nanoscope/node_modules/lodash/dist/lodash.js"}],"/Users/Ben/projects/nanoscope/src/combinator/Compose.js":[function(require,module,exports){
"use strict";
...
},{"../base/Lens":"/Users/Ben/projects/nanoscope/src/base/Lens.js","lodash":"/Users/Ben/projects/nanoscope/node_modules/lodash/dist/lodash.js"}],"/Users/Ben/projects/nanoscope/src/nanoscope.js":[function(require,module,exports){
"use strict";
...
get = function get(path, unsafe) {
    ...
    return function (obj) {
        ...
        var reduction = function reduction(acc, key) {
 ...
 * @param options
 */
PathLens = function PathLens(path, options) {
    var unsafe = options && options.unsafe,
        view = options && options._view,
 ...
 * @private
 */
_getPaths = function getPaths(prefix, obj, paths) {
    if (!paths) {
        paths = [];
    }
    ...
    _.forEach(_.keys(obj), function (key) {
        ...
        if (_.isObject(obj[key]) && !_.isArray(obj[key])) {
            paths = _getPaths(nextPrefix, obj[key], paths);
        }
    });
...
PathLens.deriveLenses = function (obj) {
    ...
    _.forEach(_getPaths(null, obj), function (path) {
...
Lens.prototype.composePath = function (path, options) {
    ...
    if (this.getFlag('_path')) {
        return new PathLens(this._flags._path + '.' + path, _.extend({ unsafe: unsafe }, options)).view(this._view);
    }
 ...
 * @returns {Function}
 */
_get = function get(plucker, recursive, object) {
    ...
    return function (viewedObject) {
        _.forEach(_.keys(viewedObject), function (property) {
            ...
            if (recursive && _.isObject(viewedObject[property])) {
                ...
                _get(plucker, recursive, object[property])(viewedObject[property]);
            }
        });
 ...
 * @returns {Function}
 */
_map = function map(plucker, recursive, object) {
    return function (viewedObject, func) {
        ...
        _.forEach(_.keys(viewedObject), function (property) {
            ...
            if (recursive && _.isObject(viewedObject[property])) {
                _map(plucker, recursive, object[property])(viewedObject[property], func);
            }
        });
 ...
 * @constructor
 */
PluckLens = function PluckLens(plucker, options) {
    ...
    this.base = Lens;
    this.base(_get(plucker, recursive), _map(plucker, recursive), flags);
};
...
},{"../base/Lens":"/Users/Ben/projects/nanoscope/src/base/Lens.js","lodash":"/Users/Ben/projects/nanoscope/node_modules/lodash/dist/lodash.js"}]},{},["/Users/Ben/projects/nanoscope/index.js"]);
